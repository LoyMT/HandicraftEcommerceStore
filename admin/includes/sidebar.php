...
<nav class="navbar navbar-inverse navbar-fixed-top"  style="background-color: #FFCC00;)"><!-- navbar navbar-inverse navbar-fixed-top begin -->
<div class="navbar-header"><!-- navbar-header begin -->
    ...
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse"><!-- navbar-toggle begin -->
        ...
        <a href="index.php?dashboard" class="navbar-brand" style="color: black; text-align:center">Admin Panel</a>
    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
            ...
            <a href="#" class="navbar-brand"><!-- dropdown-toggle begin -->
                
                <i class="fa fa-user" style="color: black;">&nbsp&nbsp<?php echo $admin_name; ?> </i>&nbsp&nbsp
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_payments"><!-- a href begin -->
                    <i class="fa fa-fw fa-dollar"></i> View Payments
                </a><!-- a href finish -->
            </li><!-- li finish -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#users"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-cogs"></i> Admins
                        <i class="fa fa-fw fa-caret-down"></i>
